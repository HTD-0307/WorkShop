...
chapter : false  
---  
# Smart Warehouse Monitoring with AWS IoT Core  
...
3. [Installing and Deploying Lambda](3-Lambda/)
4. [Configuring AWS IoT Core](4-IoT-Core/)
5. [Creating SNS](5-SNS/)
6. [S3](6-S3/)
7. [Experimental Results](7-Demo/)
8. [Video Demo](8-Video-demo/)
9. [Cleaning Up Resources](9-Clear/)